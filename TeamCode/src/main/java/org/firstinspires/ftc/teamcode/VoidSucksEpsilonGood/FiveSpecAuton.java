...
@Autonomous(name="5SpecimenSigmaMode", preselectTeleOp = "epikKodeToDriveTheRobut")
public class FiveSpecAuton extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        Action  PlaceSpec1 = drive.actionBuilder(new Pose2d(-64, -7, 0))//place first spec
                .stopAndAdd(new Slidesruntoposition(725))
                .afterTime(1,(new Slidesruntoposition(1500)))
                .strafeToLinearHeading(new Vector2d(-26.5, -0), 0)
                .stopAndAdd(new Setpositionforservo(outtakeswivel,.35))
        ...
        Action PlaceSpec2 = drive.actionBuilder(new Pose2d(-68, -41, 0))//Place Specimen 2
                ...
                .stopAndAdd(new Setpositionforservo(outtakeswivel,.35))
                .stopAndAdd(new Slidesruntoposition(725))
                .afterTime(1.7,(new Slidesruntoposition(1500)))
