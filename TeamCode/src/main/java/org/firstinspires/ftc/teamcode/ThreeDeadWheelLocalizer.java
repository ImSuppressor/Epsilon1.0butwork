...
public final class ThreeDeadWheelLocalizer implements Localizer {
    public static class Params {
        public double par0YTicks = -1652.854588648672; // y position of the first parallel encoder (in tick units)
        public double par1YTicks = 1437.3773213130594; // y position of the second parallel encoder (in tick units)
        public double perpXTicks = -1453.9882411397252; // x position of the perpendicular encoder (in tick units)
    }
